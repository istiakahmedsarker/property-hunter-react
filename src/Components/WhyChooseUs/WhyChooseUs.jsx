...
import { IoAccessibility, IoChatboxEllipses } from 'react-icons/io5';
import { BsFilterSquareFill } from 'react-icons/bs';
import SectionTitle from '../SectionTitle/SectionTitle';

const WhyChooseUs = () => {
  return (
    <section className="max-w-7xl mx-4 xl:mx-auto py-8 dark:bg-transparent my-14 md:my-20 text-primary-dark dark:text-[#e5ebee]">
      <SectionTitle
        title="Why Choose Us"
      ...
      <div className="mx-auto grid justify-center gap-4 sm:grid-cols-2 md:grid-cols-3">
        <div className="relative overflow-hidden rounded-lg bg-[#F4F4F4] dark:bg-card-dark p-2">
