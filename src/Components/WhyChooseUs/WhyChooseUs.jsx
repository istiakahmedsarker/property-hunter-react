...
const WhyChooseUs = () => {
  return (
    <Container>
      <section className="  py-8 dark:bg-transparent md:py-12 lg:py-20 text-primary-dark dark:text-[#e5ebee]">
        <SectionTitle
          title="Why Choose Us"
            ...
            <div className="flex flex-col  justify-between items-center rounded-md p-6">
              ...
              <div className="space-y-2 text-center">
                ...
                <p className="text-sm text-muted-foreground">
                  We provide dedicated support and guidance throughout the
                  buying or selling process, from initial consultation to
                  closing.
                </p>
              </div>
            </div>
          ...
          <div className="relative overflow-hidden rounded-lg bg-white dark:bg-card-dark p-2">
            <div className="flex flex-col  justify-between items-center rounded-md p-6">
              ...
              <div className="space-y-2 text-center">
                ...
                <p className="text-sm text-muted-foreground">
                  our team is readily accessible and committed to providing
                  prompt responses to your inquiries and addressing any concerns
                  you may have.
                </p>
              </div>
            </div>
          ...
          <div className="relative overflow-hidden rounded-lg bg-white dark:bg-card-dark p-2">
            <div className="flex flex-col  justify-between items-center rounded-md p-6">
              ...
              <div className="space-y-2 text-center">
                ...
                <p className="text-sm text-muted-foreground">
                  Our teams expertise in negotiation to secure the best deals
                  for clients, whether they are buying or selling properties.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="relative overflow-hidden rounded-lg bg-white dark:bg-card-dark p-2">
            <div className="flex flex-col  justify-between items-center rounded-md p-6">
              ...
              <div className="space-y-2 text-center">
                ...
                <p className="text-sm text-muted-foreground">
                  Implement advanced filtering options that allow users to
                  refine their property search based on specific criteria.
                </p>
              </div>
            </div>
          </div>
