...
const SideNav = () => {
  ...
  return (
    <div className="drawer lg:drawer-open sticky top-0 bottom-0 z-50 bg-black">
      ...
      <div className="drawer-side">
        ...
        <div className="menu w-[210px] z-50 sm:w-[250px] md:w-[280px]  dark:bg-primary-dark gap-6 min-h-full  bg-stone-500 text-base-content">
              ...
              <NavLink
                ...
                className={({ isActive }) =>
                  isActive
                    ...
                    : 'py-2 bg-white px-2 rounded-md dark:bg-[#3a3b3c] dark:text-[#e4e6cd]'
                }
              >
