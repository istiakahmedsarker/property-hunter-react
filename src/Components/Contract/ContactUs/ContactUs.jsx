          ...
          <div className="max-w-screen-xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-12  rounded-[15px]">
              <div className="bg-gray-900 md:col-span-4 p-10 text-white rounded-t-[15px] md:rounded-tr-none md:rounded-l-[15px]">
                ...
                <h3 className="text-3xl sm:text-4xl leading-10 font-extrabold">
                  Property <span className="text-primary-light">Hunter</span>
                </h3>
                <p className="mt-4 leading-7 text-gray-200">
                  Contact us to unlock the door to your perfect sale and rental
                  property.
                </p>

                <div className="flex items-center mt-5">
                  <svg
                    className="h-6 mr-2 text-primary-light"
                    fill="currentColor"
                    version="1.1"
                  ...
                  <span className="text-sm">
                    House #14, Street #12, Darulaman Road, Dhaka, Bangladesh.
                  </span>
                </div>
                <div className="flex items-center mt-5">
                  <svg
