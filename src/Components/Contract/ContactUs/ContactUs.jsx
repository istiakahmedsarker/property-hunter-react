...
const ContactUs = () => {
  return (
    <div className="py-16">
      <Container>
        <div className="flex flex-col md:flex-row items-start justify-center mt-8 mx-auto relative">
          <div className="flex-1 mx-auto px-2 text-wrap z-40">
            ...
            <div>
              <div className="flex items-center lg:gap-2">
                <div className="text-4xl text-[#eb6753]">
                    <GrMapLocation/>
                </div>
                ...
                <div className="stat">
                  ...
                  <div className="stat-desc text-lg text-black text-wrap">Humayun Road, Mohammadpur, Dhaka 1207</div>
                </div>
              </div>
              <div className="flex items-center lg:gap-2">
                <div className="text-4xl text-[#eb6753]">
                ...
                <div className="stat">
                  ...
                  <div style={{ gridColumnStart: 1, whiteSpace: 'nowrap', fontSize: '2rem', lineHeight: '2rem', fontWeight: 800 }} className="stat-value text-[#eb6753] text-wrap">314-555-0123</div>
                </div>
              </div>
              <div className="flex items-center lg:gap-2">
                <div className="text-4xl text-[#eb6753]">
                ...
                <div className="stat">
                  ...
                  <div className="stat-desc text-lg text-[#eb6753] text-wrap">hellosupport@gmail.com</div>
                </div>
              </div>
            </div>
