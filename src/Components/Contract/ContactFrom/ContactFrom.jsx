      ...
      <form ref={form} onSubmit={handleEmailSubmit}>
        <div className="flex flex-wrap -mx-3 mb-6">
          <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0">
            <label className="block uppercase tracking-wide dark:text-in-dark text-gray-700 text-xs font-bold mb-2">
              First Name
            </label>
            <input
          ...
          <div className="w-full md:w-1/2 px-3">
            <label className="block uppercase tracking-wide text-gray-700 dark:text-in-dark text-xs font-bold mb-2">
              Last Name
            </label>
            <input
