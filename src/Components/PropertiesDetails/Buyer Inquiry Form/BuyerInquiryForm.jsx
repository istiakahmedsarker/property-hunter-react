...
const BuyerInquiryForm = () => {
  ...
  const [range, setRange] = useState(80000);
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center  bg-[#f6fff5] bg-[url('https://i.ibb.co/wdYwvVV/2150799631.jpg')] bg-cover rounded-xl overflow-hidden mt-6">
      ...
      <div className="absolute z-10 top-4 right-4">
            <h1 className="text-xl text-gray-200 font-medium">{formStep + 1} / 2</h1>
        </div>
    ...
    <GrFormPrevious className="text-2xl"/>
        ...
        <div className="min-h-[30vh] mt-6">
            <img className="h-full w-full rounded-xl object-cover" src="https://i.ibb.co/wdYwvVV/2150799631.jpg" alt="" />
        </div>
          ...
          >
            ...
            {formStep === 0 && (
              <div className="grid grid-cols-6 gap-4">
                ...
                <div className="form-control col-span-6">
                 <label className="label">
                   <span className="label-text text-gray-400">Job Title</span>
                 </label>
                 <input
               ...
               <div className="form-control col-span-6">
                 <label className="label">
                   <span className="label-text text-gray-400">Annual Income : <span className={`${range < 400000 && "text-red-600"} ${range > 400000 && range < 800000 && "text-yellow-600"} ${range > 800000 && "text-green-600"}`}> {range}</span></span>
                 </label>
                 ...
                 {errors.annualIncome && <span className="text-red-500">This field is required</span>}
               </div>
              </div>
            )}
            ...
            {formStep === 1 && (
               ...
               <div className="form-control col-span-3">
                 ...
                 {errors.savings && <span className="text-red-500">This field is required</span>}
               </div>
               <div className="form-control col-span-3">
                 <label className="label">
                   <span className="label-text text-gray-400">Home Preferences</span>
                 </label>
                 <select {...register("propertyType", { required: true })} name="propertyType" id="type" className="input input-bordered">
                    <option  value="" selected disabled defaultValue="propertyType" >Type</option>
                    <option value="home">Home</option>
                    <option value="apartment">Apartment</option>
                    <option value="villa">Villa</option>
                 </select>
                 {errors.propertyType && <span className="text-red-500">This field is required</span>}
               </div>
               <div className="form-control col-span-6">
                 <label className="label">
                   <span className="label-text text-gray-400">Ask a question</span>
                 </label>
                 <textarea {...register("question", { required: true })}
                   name="question"
                   placeholder="ask a question"
                   className="px-5 py-3 rounded-lg input-bordered "
                   required id="" cols="30" rows="6"></textarea>
